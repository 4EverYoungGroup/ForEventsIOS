//
//  RecoverUserInteractorNSURLSessionImpl.swift
//  ForEvents
//
...
class RecoverUserInteractorNSURLSessionImpl: RecoverUserInteractor {
    func execute(user: UserLogin, onSuccess: @escaping (ResponseApi?) -> Void, onError: errorClosure) {
        ...
        urlComponents.path = Constants.urlRecoverPath
