//
//  DownloadEventTypesInteractorNSURLSessionImpl.swift
//  ForEvents
//
...
class DownloadEventTypesInteractorNSURLSessionImpl: DownloadEventTypesInteractor {
                ...
                if error == nil {
                    ...
                    if (self.checkStatusCode(response: response)) {
                        do {
                            ...
                            let eventTypeAPI = try decoder.decode(EventTypeAPI.self, from: data!)
                            let eventTypes = eventTypeAPI.result
                            //return User
