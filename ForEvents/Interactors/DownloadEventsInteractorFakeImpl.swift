...
class DownloadEventsInteractorFakeImpl: DownloadEventsInteractor {
    ...
    func execute(params: Dictionary<String, Any>,
        onSuccess: @escaping (Events) -> Void, onError: errorClosure = nil) {
        ...
        for i in 0...8 {
            ...
            case 0:
                ...
                event.beginDate = formatter.date(from: "2018/11/22 22:31")
            case 1:
                ...
                event.beginDate = formatter.date(from: "2018/11/23 11:00")
            case 2:
                ...
                event.beginDate = formatter.date(from: "2018/11/27 12:30")
            case 3:
                ...
                event.beginDate = formatter.date(from: "2018/12/01 16:15")
            case 4:
                ...
                event.beginDate = formatter.date(from: "2018/12/05 12:00")
            case 5:
                ...
                event.beginDate = formatter.date(from: "2018/12/06 20:00")
            case 6:
                ...
                event.beginDate = formatter.date(from: "2018/12/08 10:30")
            case 7:
                event.name = "Teatro"
                ...
                event.beginDate = formatter.date(from: "2018/12/08 19:30")
            case 8:
                ...
                event.beginDate = formatter.date(from: "2018/12/23 23:00")
            default:
                event.images = ["https://cdn.pixabay.com/photo/2015/07/10/17/53/cheers-839865_960_720.jpg"]
            }
