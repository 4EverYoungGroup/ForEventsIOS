...
func createEventsTabBar() -> UITabBarController {
    ...
    firstVC.tabBarItem =
        UITabBarItem(title: "Eventos", image: UIImage(named: "events-50"), tag: 0)
    
    secondVC.tabBarItem = UITabBarItem(title: "Mapa", image: UIImage(named: "map-marker-50"), tag: 1)
    
    thirdVC.tabBarItem = UITabBarItem(title: "Calendario", image: UIImage(named: "today-50"), tag: 2)
    
    fourthVC.tabBarItem = UITabBarItem(title: "Perfil", image: UIImage(named: "contacts-50"), tag: 3)
    
    tabBarList.viewControllers = [firstVC, secondVC, thirdVC, fourthVC]
   
    //Configure text of tabbaritem
        let selectedColor = CustomColors.orangeColor
        let unselectedColor = CustomColors.unselectedColor
